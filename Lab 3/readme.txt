Important :
    1. For functionality of back button to work after submitting the survey please disable cache 
    from network tab in browser's developer options otherwise it would throw an browser error of cannot submit form.
